...
The architeture used here is more of a Cloud-native architecture, especially a hosted version (ie kubernetes and docker). Though this can easily be adapted to a more stateless hosted version (ie Azure Functions).
